...
func MirrorSubResourceCondition(conditions condition.Conditions, targetCondition condition.Type, instance *corev1.OpenStackControlPlane, subResource string) {
