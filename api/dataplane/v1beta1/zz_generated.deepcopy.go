...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AnsibleExecutionSummary) DeepCopyInto(out *AnsibleExecutionSummary) {
	*out = *in
	...
	if in.FailedHosts != nil {
		in, out := &in.FailedHosts, &out.FailedHosts
		*out = new(int)
		**out = **in
	}
	if in.UnreachableHosts != nil {
		in, out := &in.UnreachableHosts, &out.UnreachableHosts
		*out = new(int)
		**out = **in
	}
	if in.FailurePercent != nil {
		in, out := &in.FailurePercent, &out.FailurePercent
		*out = new(int)
		**out = **in
	}
	if in.FailedHostList != nil {
		in, out := &in.FailedHostList, &out.FailedHostList
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
	...
	if in.UnreachableHostList != nil {
		in, out := &in.UnreachableHostList, &out.UnreachableHostList
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnsibleExecutionSummary.
func (in *AnsibleExecutionSummary) DeepCopy() *AnsibleExecutionSummary {
	if in == nil {
		return nil
	}
	out := new(AnsibleExecutionSummary)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackDataPlaneDeploymentStatus) DeepCopyInto(out *OpenStackDataPlaneDeploymentStatus) {
	*out = *in
	...
	if in.AnsibleExecutionSummaries != nil {
		in, out := &in.AnsibleExecutionSummaries, &out.AnsibleExecutionSummaries
		*out = make(map[string]AnsibleExecutionSummary, len(*in))
		for key, val := range *in {
...
func (in *OpenStackDataPlaneNodeSetStatus) DeepCopyInto(out *OpenStackDataPlaneNodeSetStatus) {
	*out = *in
	...
	if in.DeploymentExecutionSummaries != nil {
		in, out := &in.DeploymentExecutionSummaries, &out.DeploymentExecutionSummaries
		*out = make(map[string]map[string]AnsibleExecutionSummary, len(*in))
		for key, val := range *in {
			var outVal map[string]AnsibleExecutionSummary
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
