...
//+kubebuilder:webhook:path=/mutate-net-openstack-org-v1beta1-openstacknetattachment,mutating=true,failurePolicy=fail,sideEffects=None,groups=net.openstack.org,resources=openstacknetattachments,verbs=create;update,versions=v1beta1,name=mopenstacknetattachment.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-net-openstack-org-v1beta1-openstacknetattachment,mutating=false,failurePolicy=fail,sideEffects=None,groups=net.openstack.org,resources=openstacknetattachments,verbs=create;update,versions=v1beta1,name=vopenstacknetattachment.kb.io,admissionReviewVersions=v1
