...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSEndpointConfig) DeepCopyInto(out *TLSEndpointConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSEndpointConfig.
func (in *TLSEndpointConfig) DeepCopy() *TLSEndpointConfig {
	if in == nil {
		return nil
	}
	out := new(TLSEndpointConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TLSSection) DeepCopyInto(out *TLSSection) {
	*out = *in
	if in.Endpoint != nil {
		...
		*out = make(map[service.Endpoint]TLSEndpointConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *TLSStatus) DeepCopyInto(out *TLSStatus) {
	*out = *in
	if in.Endpoint != nil {
		in, out := &in.Endpoint, &out.Endpoint
		*out = make(map[service.Endpoint]TLSCAStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
