...
type KeystoneSection struct {
	...
	Override KeystoneOverrideSpec `json:"override,omitempty"`
}

// KeystoneOverrideSpec to override the generated manifest of several child resources.
type KeystoneOverrideSpec struct {
	// +kubebuilder:validation:Optional
