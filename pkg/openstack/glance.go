...
func ReconcileGlance(ctx context.Context, instance *corev1beta1.OpenStackControlPlane, helper *helper.Helper) (ctrl.Result, error) {
	...
	serviceOverrides := map[string]service.RoutedOverrideSpec{}
	if instance.Spec.Glance.Template.GlanceAPIExternal.Override.Service != nil {
		serviceOverrides[string(service.EndpointPublic)] = *instance.Spec.Glance.Template.GlanceAPIExternal.Override.Service
	}
	if instance.Spec.Glance.Template.GlanceAPIInternal.Override.Service != nil {
		serviceOverrides[string(service.EndpointInternal)] = *instance.Spec.Glance.Template.GlanceAPIInternal.Override.Service
	}
