...
func ReconcileOctavia(ctx context.Context, instance *corev1beta1.OpenStackControlPlane, helper *helper.Helper) (ctrl.Result, error) {
	...
	for _, endpointType := range []service.Endpoint{service.EndpointPublic, service.EndpointInternal} {
		if instance.Spec.Octavia.Template.OctaviaAPI.Override.Service == nil {
			instance.Spec.Octavia.Template.OctaviaAPI.Override.Service = map[string]service.RoutedOverrideSpec{}
		}
		instance.Spec.Octavia.Template.OctaviaAPI.Override.Service[string(endpointType)] =
			AddServiceComponentLabel(
				ptr.To(instance.Spec.Octavia.Template.OctaviaAPI.Override.Service[string(endpointType)]),
				octavia.Name)
	}
