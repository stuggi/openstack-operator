...
func ReconcileCinder(ctx context.Context, instance *corev1beta1.OpenStackControlPlane, helper *helper.Helper) (ctrl.Result, error) {
	...
	for _, endpointType := range []service.Endpoint{service.EndpointPublic, service.EndpointInternal} {
		if instance.Spec.Cinder.Template.CinderAPI.Override.Service == nil {
			instance.Spec.Cinder.Template.CinderAPI.Override.Service = map[string]service.RoutedOverrideSpec{}
		}
		instance.Spec.Cinder.Template.CinderAPI.Override.Service[string(endpointType)] =
			AddServiceComponentLabel(
				ptr.To(instance.Spec.Cinder.Template.CinderAPI.Override.Service[string(endpointType)]),
				cinder.Name)
	}
