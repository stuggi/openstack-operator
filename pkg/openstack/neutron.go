...
func ReconcileNeutron(ctx context.Context, instance *corev1beta1.OpenStackControlPlane, helper *helper.Helper) (ctrl.Result, error) {
	...
	for _, endpointType := range []service.Endpoint{service.EndpointPublic, service.EndpointInternal} {
		if instance.Spec.Neutron.Template.Override.Service == nil {
			instance.Spec.Neutron.Template.Override.Service = map[string]service.RoutedOverrideSpec{}
		}
		instance.Spec.Neutron.Template.Override.Service[string(endpointType)] =
			AddServiceComponentLabel(
				ptr.To(instance.Spec.Neutron.Template.Override.Service[string(endpointType)]),
				neutronAPI.Name)
	}
