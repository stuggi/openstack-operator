...
require (
	...
	github.com/openstack-k8s-operators/barbican-operator/api v0.6.1-0.20260314075329-07972699673b
	github.com/openstack-k8s-operators/cinder-operator/api v0.6.1-0.20260314075323-13c875b58d0f
	github.com/openstack-k8s-operators/designate-operator/api v0.6.1-0.20260314103230-ba6e6b4b4a95
	...
	github.com/openstack-k8s-operators/lib-common/modules/ansible v0.6.1-0.20260310070607-b96da8dd520e
	github.com/openstack-k8s-operators/lib-common/modules/certmanager v0.6.1-0.20260310070607-b96da8dd520e
	...
	github.com/openstack-k8s-operators/octavia-operator/api v0.6.1-0.20260314103518-fbebe65acec6
	github.com/openstack-k8s-operators/openstack-baremetal-operator/api v0.6.1-0.20260314104055-3878b7bcd6b7
	...
	github.com/openstack-k8s-operators/telemetry-operator/api v0.6.1-0.20260314104344-15c2ffcfe08e
	github.com/openstack-k8s-operators/test-operator/api v0.6.1-0.20260304131340-9117f35b7132
...
replace github.com/openstack-k8s-operators/lib-common/modules/common => github.com/stuggi/lib-common/modules/common v0.0.0-20260326081252-c4fb97e10a11

replace github.com/openstack-k8s-operators/lib-common/modules/certmanager => github.com/stuggi/lib-common/modules/certmanager v0.0.0-20260326081252-c4fb97e10a11

replace github.com/openstack-k8s-operators/mariadb-operator/api => github.com/stuggi/mariadb-operator/api v0.0.0-20260326084111-245c27b120d4

replace github.com/openstack-k8s-operators/glance-operator/api => github.com/stuggi/glance-operator/api v0.0.0-20260325170450-449cc931cfcc

replace github.com/openstack-k8s-operators/infra-operator/apis => github.com/stuggi/infra-operator/apis v0.0.0-20260325164319-73632a4f5d6a

replace github.com/openstack-k8s-operators/swift-operator/api => github.com/stuggi/swift-operator/api v0.0.0-20260325170451-f1bc1e736688

replace github.com/openstack-k8s-operators/designate-operator/api => github.com/stuggi/designate-operator/api v0.0.0-20260325170922-f997f865ce02
