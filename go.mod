...
require (
	...
	github.com/openstack-k8s-operators/dataplane-operator/api v0.0.0-20230316152725-7e5bfdd67585
	...
	github.com/openstack-k8s-operators/openstack-ansibleee-operator/api v0.0.0-20230315095729-8ef965593d25
	github.com/openstack-k8s-operators/openstack-operator/apis v0.0.0-20230315094603-ab830c7ef1cd
...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/storage v0.0.0-20230316162802-ec9e5af1b048 // indirect; indirect // indirect // indirect // indirect // indirect // indirect // indirect // indirect // indirect // indirect
